...
export default class Particle {
    ...
    update(centerX, centerY, width, height) {
        ...
        this.position.x = this.shift.x + Math.cos(this.id + this.offset.x) * this.orbit * CONST.PLAYER_ORBIT_SCALE
        this.position.y = this.shift.y + Math.sin(this.id + this.offset.y) * this.orbit * CONST.PLAYER_ORBIT_SCALE
